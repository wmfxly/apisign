...
import com.apisign.demo.util.MD5Util;
import com.apisign.demo.util.RedisStringUtil;
import com.apisign.demo.util.ResultUtil;
import com.apisign.demo.util.ServletUtil;
...
public class SignInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        String params = StreamUtils.copyToString(request.getInputStream(), StandardCharsets.UTF_8);
        logger.info("request contextType ={},get params = {}", request.getContentType(), params);
        //得到正确的sign供检验用
        ...
        logger.info("client sign = {},origin = {},signEcrypt={}", sign, origin, signEcrypt);
        long timestamp = 0;
        try {
        ...
        //sign校验无问题,放行
        start.stop();
        logger.info("执行时间 毫秒 {}", start.getLastTaskTimeMillis());
        return true;
    }
